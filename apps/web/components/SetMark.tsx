const MARKS: Record<string, [string, string?]> = {
  waves: [
    'M8.5 11.5a3.5 3.5 0 0 1 7 0M12 4v2M6.5 6.5 8 8M17.5 6.5 16 8M4 11.5h2M18 11.5h2',
  ...
  peaks: ['M2 19h20L15 6l-4 7-2-3-7 9Z', 'M15 6l3.5 6.5'],
  crystal: ['M12 3 4 9l8 12 8-12-8-6Z', 'M12 3v18M4 9h16'],
  record: [
    'M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18Zm0 6a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z',
    'M12 11.4a.6.6 0 1 0 0 1.2',
  ],
  feather: ['M20 4C11 4 5 10 5 19l3-3c8 0 12-5 12-12Z', 'M4 20l7-7'],
  ...
  key: [
    'M15 4a5 5 0 1 1-4.2 7.7L4 18.5V21h3l1-2h2l1-2h2l.8-1.7A5 5 0 0 1 15 4Z',
    'M16.5 8a1 1 0 1 0 0 .01',
  ],
  bloom: [
    'M12 12a3 3 0 1 0 0-.01M12 9V4M12 15v5M9 12H4M15 12h5',
    'M9.2 9.2 6 6M14.8 9.2 18 6M9.2 14.8 6 18M14.8 14.8 18 18',
  ],
  orbit: [
